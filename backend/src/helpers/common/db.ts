...
class Database implements DBInterface {
  ...
  constructor() {
    ...
    // console.log("this.connectionWrite", this.connectionWrite)
    ...
    this.db_read
      .authenticate()
      .then(() => {
        console.debug("Database connected successfully.".blue);
      })
      .catch((error: any) => {
        console.error(`Unable to connect to the database: ${config.DB.DB_NAME}`, error);
      });
  }
