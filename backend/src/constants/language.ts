export const language: any = {
    en: {
        ...
        // Maker - Checker
        INVALID_CHECKER_CODE: 'Invalid Checker Code',
        INVALID_WALLET_ADDRESS: 'Invalid Wallet Address',
        INVALID_WALLET_NAME: 'Invalid Wallet Name',
        INVALID_DEVICE_ID: 'Cannot be added as a Maker wallet on the same device',

        ASKING_FOR_ACCESS_TITTLE: `Account Access`,
        ACCESSED_SUCCESSFULLY_TITTLE: `Congratulations!`,
        ACCESS_DECLINED_TITTLE: `Declined`,
        TRNX_REJECTED_TITLE: `Transaction Rejected`,
        TRNX_SIGNED_TITLE: `Transaction Signed`,

        TRNX_REJECTED_APPROVAL_TITLE: `Transaction Approval Rejected`,
        TRNX_SIGNED_APPROVAL_TITLE: `Transaction Approval`,

        ASKING_FOR_ACCESS: `Maker has requested account access.`,
        ACCESSED_SUCCESSFULLY: `Your Maker account is now ready to use.`,
        ACCESS_DECLINED: `Your request has been declined. Please try again.`,
        TRNX_APPROVAL_APPROVED: (cryptoAmount: string, coinSymbol: string) => `Transaction (${cryptoAmount} ${coinSymbol}) approval has been approved by the Checker.`,
        TRNX_APPROVAL_REJECTED: (cryptoAmount: string, coinSymbol: string) => `Transaction (${cryptoAmount} ${coinSymbol}) approval has been rejected by the Checker.`,
        TRNX_APPROVED: (cryptoAmount: string, coinSymbol: string) => `Transaction (${cryptoAmount} ${coinSymbol}) has been signed by the Checker.`,
        TRNX_REJECTED: (cryptoAmount: string, coinSymbol: string) => `Transaction (${cryptoAmount} ${coinSymbol}) has been rejected by the Checker.`,
        TRNX_REQUEST_TITLE: `Transaction Sign`,
        TRNX_APPROVAL_REQUEST_TITLE: `Transaction Approval`,
        TRANSACTION_REQUEST_SENT: `A new transaction has been performed by the Maker.`,
        TRANSACTION_APPROVAL_REQUEST_SENT: `A new transaction approval has been performed by the Maker.`,
        REQUEST_EXIST: 'Request already exist.',
        REQUEST_SESSION_EXPIRED: 'Request Expired',
        // Changelly
        CHANGE_MIN_AMOUNT: (crytpAmount: string, coinSymbol: string) => `Minimal amount is ${crytpAmount} ${coinSymbol}.`
    },
    sp: {
        //Wallets
        ...
        MIN_BALANCE: (balance: any, currency: string, coin_symbol: string, coin: string, token_type: string) => `Para enviar ${coin_symbol.toUpperCase()
            } (${token_type.toUpperCase()}), necesita financiar ${coin.toUpperCase()} para la tarifa del gas(mínimo ${balance} ${currency})`,
        // Alchemy
        FAILED: 'FALLIDA',
        // BTC
        ...
        ADDRESS_BOOK_EDITED: 'Address Book updated successfully.',
        ...
        // Maker - Checker
        INVALID_CHECKER_CODE: 'Código de verificación no válido',
        INVALID_WALLET_ADDRESS: 'Dirección de billetera no válida',
        INVALID_WALLET_NAME: 'Nombre de billetera no válido',
        INVALID_DEVICE_ID: 'No se puede agregar como billetera Maker en el mismo dispositivo',

        ASKING_FOR_ACCESS_TITTLE: `Acceso a la cuenta`,
        ACCESSED_SUCCESSFULLY_TITTLE: `¡Felicidades!`,
        ACCESS_DECLINED_TITTLE: `Rechazada`,
        TRNX_REJECTED_TITLE: `Transacción rechazada`,
        TRNX_SIGNED_TITLE: `Transacción firmada`,

        TRNX_REJECTED_APPROVAL_TITLE: `Aprobación de transacción rechazada`,
        TRNX_SIGNED_APPROVAL_TITLE: `Aprobación de transacción`,

        ASKING_FOR_ACCESS: `Maker ha solicitado acceso a la cuenta.`,
        ACCESSED_SUCCESSFULLY: `Tu cuenta Maker ya está lista para usar.`,
        ACCESS_DECLINED: `Su solicitud ha sido rechazada.Inténtalo de nuevo.`,
        TRNX_APPROVED: (cryptoAmount: string, coinSymbol: string) => `La transacción(${cryptoAmount} ${coinSymbol}) ha sido firmada por el Verificador.`,
        TRNX_REJECTED: (cryptoAmount: string, coinSymbol: string) => `El verificador ha rechazado la transacción(${cryptoAmount} ${coinSymbol}).`,

        TRNX_APPROVAL_APPROVED: (cryptoAmount: string, coinSymbol: string) => `La aprobación de la transacción (${cryptoAmount} ${coinSymbol}) ha sido aprobada por el Verificador.`,
        TRNX_APPROVAL_REJECTED: (cryptoAmount: string, coinSymbol: string) => `La aprobación de la transacción (${cryptoAmount} ${coinSymbol}) ha sido rechazada por el Verificador.`,

        TRNX_REQUEST_TITLE: `Signo de transacción`,
        TRANSACTION_REQUEST_SENT: `El Creador ha realizado una nueva transacción.`,
        REQUEST_EXIST: 'La solicitud ya existe.',
        REQUEST_SESSION_EXPIRED: 'Solicitud caducada',
        // Changelly
        CHANGE_MIN_AMOUNT: (crytpAmount: string, coinSymbol: string) => `La cantidad mínima es ${crytpAmount} ${coinSymbol}.`
