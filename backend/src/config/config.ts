import zookeeperConfig from "../connections/zookeeperClient";
...
export const config = {
  ...
  SMTP_CONFIG : zookeeperConfig.config.SMTP,
  DB: {
  ...
  POL_WALLET_ADDRESS: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.POL_WALLET_ADDRESS}`,
  ...
  RSA_ENC_PRIVATE_KEY_NAME: zookeeperConfig.config.RSA_PRIVATE_KEY_NAME,
  RSA_ENC_PUBLIC_KEY_NAME: zookeeperConfig.config.RSA_PUBLIC_KEY_NAME,
  STATIC_COIN_FAMILY: zookeeperConfig.config.STATIC_COIN_FAMILY,
  NODE: {
    POL_RPC_URL : zookeeperConfig.config.POL_RPC_URL,
  ...
  PRICEALERT_LIST: zookeeperConfig.config.REDIS_PRICEALERT_LIST || "PRICE_ALERT_LIST",
