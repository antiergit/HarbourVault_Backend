...
export const config = {
  ...
  DEPOSIT_WITHDRAW_PROCESS_ETH: zookeeperConfig.config.DEPOSIT_WITHDRAW_PROCESS_POL,
  ETH_WALLET_ADDRESS: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.POL_WALLET_ADDRESS}`,
  // WITHDRAW_QUEUE_BLOCKS_PROCESS: zookeeperConfig.config.WITHDRAW_QUEUE_BLOCKS_PROCESS,
  PENDING_WITHDRAWAL_TX_PROCESS_ETH: zookeeperConfig.config.PENDING_WITHDRAWAL_TX_PROCESS_POL,
  ...
  TOKEN_TYPE_ETH: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.TOKEN_TYPE_POL}`,
  TOKEN_TYPE721_ETH: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.TOKEN_TYPE721_POL}`,
  COIN_FAMILY_ETH: zookeeperConfig.config.COIN_FAMILY_POL,
  // added new
  KEYS: {
  ...
  REDISKEYS: {
    ETH_BLOCKS: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.POL_BLOCKS} `,
    OLD_BLOCK_ETH: zookeeperConfig.config.OLD_BLOCK_POL,
    NEW_BLOCK_ETH: zookeeperConfig.config.NEW_BLOCK_POL,
    ALL_PROCESSES: zookeeperConfig.config.ALL_PROCESSES,
    ETH_ERROR_LOGS: zookeeperConfig.config.POL_ERROR_LOGS,
    NODE_ALERT_ETH: zookeeperConfig.config.NODE_ALERT_POL,
    SPECIFIC_BLOCK_ETH: zookeeperConfig.config.SPECIFIC_BLOCK_POL
  },
   ...
   */
  TRANSACTIONS: {
    eth_behined_transactions: zookeeperConfig.config.pol_behined_transactions,
    eth_all_blocks: zookeeperConfig.config.pol_all_blocks,
    eth_transaction_consumer_count: zookeeperConfig.config.pol_transaction_consumer_count
  },
  MAILGUN: {
  ...
  NODE: {
    ...
    ETH_RPC_URL: zookeeperConfig.config.POL_RPC_URL,
  ...
  READ_BEHINED_BLOCK_ETH: `${name}_${zookeeperConfig.config.SERVER}_${zookeeperConfig.config.READ_BEHINED_BLOCK_POL}`,
